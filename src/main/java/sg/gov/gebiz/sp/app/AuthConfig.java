...
public class AuthConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * @Bean public MetadataGenerator metadataGenerator() { MetadataGenerator
	 * metadataGenerator = new MetadataGenerator();
	 * metadataGenerator.setEntityId(getEntityId());
	 * metadataGenerator.setExtendedMetadata(extendedMetadata());
	 * metadataGenerator.setIncludeDiscoveryExtension(false);
	 * metadataGenerator.setKeyManager(keyManager()); return metadataGenerator;
	 * }
	 

	
	 * @Bean public KeyManager keyManager() { String storePass = getSecret();
	 * Map<String, String> passwords = new HashMap<>(); passwords.put(alias,
	 * getSecret()); return new JKSKeyManager(keyStore, storePass, passwords,
	 * alias); }
	 ...
	 * @Bean public ExtendedMetadata extendedMetadata() { ExtendedMetadata
	 * extendedMetadata = new ExtendedMetadata();
	 * extendedMetadata.setIdpDiscoveryEnabled(false);
	 * extendedMetadata.setSignMetadata(false); return extendedMetadata; }
	...
	public ExtendedMetadataDelegate idpMetadata() throws MetadataProviderException, ResourceException, IOException {
		 ...
		 * HTTPMetadataProvider(backgroundTaskTimer, new HttpClient(),
	 ...
	 * 
	 * public void setKeyStore(Resource keyStore) { this.keyStore = keyStore; }
	 * 
